...
contract Vault {
    ...
    // create a deposit function that mints token to the user
    // create a redeem function that burns tokens from the user and sends the user ETH
    // create a way to add rewads to the vault
    ...
    function deposit() external payable {
        // 1. we need to use the amount of ETH the user has sent to mint toknes to the user
     ...
     * @param _amount The amount of rebse tokens to redeem
     */
    function redeem(uint256 _amount) external {
        ...
        // payable(msg.sender).transfer(_amount); Not good practice
